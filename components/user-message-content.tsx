...
const UserMessageContent: React.FC<UserMessageContentProps> = ({ content }) => {
  ...
  return (
    <Card className="w-full p-4 bg-primary text-primary-foreground shadow-lg relative overflow-hidden group transition-all duration-200 hover:shadow-xl hover:shadow-primary/10">
      ...
      <button
        ...
        className="absolute top-2 right-2 p-1.5 rounded-full bg-primary-foreground/10 hover:bg-primary-foreground/20 text-primary-foreground/70 hover:text-primary-foreground transition-all duration-200 opacity-0 group-hover:opacity-100"
